...
class ActiveRecord {
    ...
    // Busca un registro por otro atributo
    public static function where($atributo, $valor) {
    ...
    public static function SQL($consultaSQL) {
        $resultado = self::consultarSQL($consultaSQL);
        return $resultado;
    }
